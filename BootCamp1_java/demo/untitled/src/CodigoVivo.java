...
public static void main(String[] args) {
    ...
    // toma del String pool y compara siendo la misma referencia dado que no se instancio el objeto
    System.out.println(a == c);  // true
    // toma del String pool y compara siendo la misma referencia dado que no se instancio el objeto
    System.out.println(a == d);  //  true
    //// d se crea de un literal existente (intern) del String pool y apunta a la mima cadena de allí que resulta o mismo
